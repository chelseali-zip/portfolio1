  ...
  const image = (
    <Image
      ...
      className={`object-cover ${
        isAvailable ? "transition duration-700 ease-editorial group-hover:scale-[1.035]" : ""
      }`}
    />
  );
  ...
  return (
    ...
    >
      {isAvailable ? (
        ...
        <div className="image-col relative block aspect-[16/11] overflow-hidden rounded-[28px] bg-neutral-100 md:col-span-7">
          {image}
        </div>
      )}
      <div className="md:col-span-5">
        ...
        <p className="mt-6 text-sm font-medium uppercase tracking-[.16em] text-blue">
          {isAvailable ? project.category : "Case Study Coming Soon"}
        </p>
